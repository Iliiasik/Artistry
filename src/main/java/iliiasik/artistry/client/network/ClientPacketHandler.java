...
public final class ClientPacketHandler {
    ...
    public static void onSyncCanvas(SyncCanvasS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void onPosterRemoved(PosterRemovedS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
    ...
    public static void onSyncImageLayer(SyncImageLayerS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.level == null) return;
            BlockPos pos = payload.pos();
    ...
    public static void onDeliverImage(DeliverImageS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void onImageUploaded(ImageUploadedS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.screen instanceof PaintScreen screen) {
    ...
    public static void onImageEvicted(ImageEvictedS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
    ...
    public static void onSyncImageLock(SyncImageLockS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.level == null) return;
            BlockPos pos = payload.pos();
    ...
    public static void onCanvasCursor(CanvasCursorS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.screen instanceof PaintScreen screen) {
                if (payload.pos().equals(screen.getTargetPos())) {
    ...
    public static void onCanvasPresenceLeave(CanvasPresenceLeaveS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.screen instanceof PaintScreen screen) {
                if (payload.pos().equals(screen.getTargetPos())) {
    ...
    public static void onCanvasEnterAllowed(CanvasEnterAllowedS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() -> {
            Minecraft mc = Minecraft.getInstance();
            if (mc.level == null) return;
    ...
    public static void onServerSettings(ServerSettingsS2CPacket payload, IPayloadContext context) {
        context.enqueueWork(() ->
