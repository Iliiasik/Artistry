...
public class ColorPaletteWidget extends AbstractWidget {
    ...
    private static final ResourceLocation SPECTRUM_ID = new ResourceLocation("artistry", "palette_spectrum_cache");
    private static final ResourceLocation HSV_ID      = new ResourceLocation("artistry", "palette_hsv_cache");
