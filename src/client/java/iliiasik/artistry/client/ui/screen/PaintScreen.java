...
public class PaintScreen extends Screen {
    ...
    protected void init() {
        ...
        widgets.build(this::addDrawableChild);
    ...
    private void tickCursor() {
        ...
        double gx = MathHelper.clamp((hoverMouseX - dims.drawingAreaX) / ps, 0.0, canvasData.canvasSize);
        double gy = MathHelper.clamp((hoverMouseY - dims.drawingAreaY) / ps, 0.0, canvasData.canvasSize);
