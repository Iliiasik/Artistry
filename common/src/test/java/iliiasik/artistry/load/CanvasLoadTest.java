...
class CanvasLoadTest {
    ...
    void fullCanvasSyncPacketRoundTrips() {
        ...
        SyncCanvasS2CPacket.CODEC.encode(buf, packet);
        int size = buf.readableBytes();
        SyncCanvasS2CPacket decoded = SyncCanvasS2CPacket.CODEC.decode(buf);
    ...
    void fullImageLayerPacketRoundTrips() {
        ...
        RegistryFriendlyByteBuf buf = McFixture.buffer();
        SyncImageLayerS2CPacket.CODEC.encode(buf, packet);
        SyncImageLayerS2CPacket decoded = SyncImageLayerS2CPacket.CODEC.decode(buf);
