...
class RecipeResourceTest {
    ...
    private static JsonObject recipe(String name) throws IOException {
        return read("/data/artistry/recipe/" + name + ".json");
    }
    ...
    void bannerRecipeIsShaped() throws IOException {
        ...
        assertEquals("artistry:banner", banner.getAsJsonObject("result").get("id").getAsString());
    }
    ...
    void recipesAreUnlocked() throws IOException {
        for (String name : List.of("poster", "banner")) {
            JsonObject advancement = read("/data/artistry/advancement/recipes/misc/" + name + ".json");
    ...
    void posterRecipeIsIntact() throws IOException {
        ...
        assertEquals("artistry:poster", poster.getAsJsonObject("result").get("id").getAsString());
