...
public final class BlockPalette {
    ...
    public static final String[] BLOCK_IDS = {
            ...
            "minecraft:rooted_dirt",            "minecraft:reinforced_deepslate",   "minecraft:muddy_mangrove_roots",
    ...
    public static void ensureLoaded() {
        ...
        TextureAtlas atlas = (TextureAtlas) mc.getTextureManager().getTexture(InventoryMenu.BLOCK_ATLAS);
        for (int i = 0; i < COUNT; i++) {
            try {
                Block block = BuiltInRegistries.BLOCK.get(new ResourceLocation(BLOCK_IDS[i]));
