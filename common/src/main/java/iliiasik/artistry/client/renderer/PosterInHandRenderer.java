...
public class PosterInHandRenderer {
    ...
    public static void render(PoseStack matrices, MultiBufferSource vertexConsumers,
        ...
        vc.addVertex(mat, BORDER,        SIZE - BORDER, 0).setColor(255,255,255,255).setUv(0f, 1f).setLight(light);
        vc.addVertex(mat, SIZE - BORDER, SIZE - BORDER, 0).setColor(255,255,255,255).setUv(1f, 1f).setLight(light);
        vc.addVertex(mat, SIZE - BORDER, BORDER,        0).setColor(255,255,255,255).setUv(1f, 0f).setLight(light);
        vc.addVertex(mat, BORDER,        BORDER,        0).setColor(255,255,255,255).setUv(0f, 0f).setLight(light);

        renderImages(vertexConsumers, light, stack, mat);

        VertexConsumer frame = vertexConsumers.getBuffer(RenderType.text(ModTextures.IN_HAND_FRAME));
        frame.addVertex(mat, 0,    SIZE, 0).setColor(255,255,255,255).setUv(0f, 1f).setLight(light);
        frame.addVertex(mat, SIZE, SIZE, 0).setColor(255,255,255,255).setUv(1f, 1f).setLight(light);
        frame.addVertex(mat, SIZE, 0,    0).setColor(255,255,255,255).setUv(1f, 0f).setLight(light);
        frame.addVertex(mat, 0,    0,    0).setColor(255,255,255,255).setUv(0f, 0f).setLight(light);
    }
    ...
    private static void renderImages(MultiBufferSource vertexConsumers,
        ...
        for (VisibleFragment frag : fragments) {
            ...
            imgVc.addVertex(mat, x0, y1, Z_IMAGES).setColor(255,255,255,255).setUv(frag.u0(), frag.v1()).setLight(light);
            imgVc.addVertex(mat, x1, y1, Z_IMAGES).setColor(255,255,255,255).setUv(frag.u1(), frag.v1()).setLight(light);
            imgVc.addVertex(mat, x1, y0, Z_IMAGES).setColor(255,255,255,255).setUv(frag.u1(), frag.v0()).setLight(light);
            imgVc.addVertex(mat, x0, y0, Z_IMAGES).setColor(255,255,255,255).setUv(frag.u0(), frag.v0()).setLight(light);
        }
    }
}